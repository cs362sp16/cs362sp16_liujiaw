...
int my_CouncilRoom(int handPos, int currentPlayer, struct gameState *state)
{
    int i;
...
int my_Salvager(int handPos, int currentPlayer, int choice1, struct gameState *state)
{
    //+1 buy
    state->numBuys++;
