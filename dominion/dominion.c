...
void my_Great_hall(int currentPlayer,struct gameState* state, int handPos){
      //+1 Card
...
int my_Smithy(int handPos, int currentPlayer, struct gameState *state)
{
    int i;
...
int my_Village(int handPos, int currentPlayer, struct gameState *state)
{
    //+1 Card
    drawCard(currentPlayer, state);
...
int my_Steward(int handPos, int currentPlayer, int choice1, int choice2, int choice3, struct gameState *state)
{
    if (choice1 == 1)
    {
        //+2 cards
...
void my_Minion (int currentPlayer, struct gameState*  state, int handPos, int choice1, int choice2){
    //+1 action
    int i;
    int j;
      state->numActions++;
...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
      ...
      if (choice1)
    {
      ...
      return 0;
        ...
        case great_hall:
                my_Great_hall(currentPlayer, state, handPos);
            return 0;
            
        case minion:
                my_Minion(currentPlayer, state, handPos, choice1, choice2);
            return 0;
